...
const NavCom = () => {
    ...
    return ( <
            ...
            <
            Navbar style = {
                { backgroundColor: "#51B5E0", marginTop: 0 }
            }
            light expand = "md" >
            <
    ...
    NavbarText style = {
            { color: "black" }
        } > < b > kidas2015bd @gmail.com < /b></NavbarText >
        <
        NavbarText > & nbsp; & nbsp; < /NavbarText> <
    NavbarText style = {
            { color: "black" }
        } > < b > +8801712560276 < /b></NavbarText >
        <
        NavbarText > & nbsp; & nbsp; < /NavbarText> <
    AlertDialogSlide / > { /* </Collapse> */ } <
        /Navbar> <
    Switch >
        <
