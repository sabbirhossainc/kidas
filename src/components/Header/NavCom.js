...
const NavCom = () => {
  ...
  return (
    <div>
      <Router>
        <Navbar style={{ backgroundColor: "#51B5E0", marginTop:0}} light expand="md">
          ...
          <Nav className="mr-auto" navbar>
            ...
            <NavItem>
              <NavLink>
                <Link className={classes.root} to="/edu-program" style={{ color: "black" }}>
                  Education Program
                </Link>
              </NavLink>
            </NavItem>
              <NavLink>
                <Link className={classes.root} to="/notice-board" style={{ color: "black" }}>
                  Notice Board
                </Link>
              </NavLink>
            <UncontrolledDropdown nav inNavbar>&nbsp;&nbsp;
              <DropdownToggle caret style={{backgroundColor:"#5A4C41", color:"white"}}  >
                Services
              </DropdownToggle>
              <DropdownMenu right>
                <DropdownItem>
          ...
          <NavbarText style={{color:"black"}}><b>kidas2015bd@gmail.com</b></NavbarText>
          <NavbarText>&nbsp; &nbsp; </NavbarText>
          <NavbarText style={{color:"black"}}><b>+8801712560276</b></NavbarText>
          <NavbarText>&nbsp; &nbsp; </NavbarText>
          <AlertDialogSlide />
          {/* </Collapse> */}
        </Navbar>
