...
const Ts = () => {
  return (
    <Container>
      <Typography variant="body1" color="textSecondary" component="p">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, qui ipsam. Dolores suscipit amet facere,
